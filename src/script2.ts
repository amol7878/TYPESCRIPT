...
let cities:string[]=["pune","mumbai","nashik","chennai","kolkata"]
console.log(cities)

let numbers:number[]=[11,22,33,44,55,66,77,88]
console.log(numbers)
...
function mul(x2:number,y2:number):void{
    console.log(x2*y2)
}

mul(12,4)

function mulB(x1:number,y1:number):number{
    console.log(x1*y1)
    return x1*y1
}
let q1=mulB(2,3)
...
let fruit:string[]=["apple","mango","banan","grapes"]
